...
mixin _$Result<T> {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(OpenChatException error) failure,
  }) => throw _privateConstructorUsedError;
  @optionalTypeArgs
  TResult? whenOrNull<TResult extends Object?>({
    TResult? Function(T value)? success,
    TResult? Function(OpenChatException error)? failure,
  }) => throw _privateConstructorUsedError;
  @optionalTypeArgs
...
abstract class _$$FailureImplCopyWith<T, $Res> {
  ...
  @useResult
  $Res call({OpenChatException error});
}
...
abstract class Failure<T> extends Result<T> {
  const factory Failure(final OpenChatException error) = _$FailureImpl<T>;
  const Failure._() : super._();

  OpenChatException get error;
